...
public class switchCaseJava_g {
    ...
    switch (month) {
        ...
        case "February": day=(checkLeap(year)?20:28); break;
        ...
        case "September":day=31;  break;
        case "October": day=30;break;
        case "November": day=31;break;
        case "December": day=31;break;
        default: System.out.println("is not a month (String)"); break;
    }
